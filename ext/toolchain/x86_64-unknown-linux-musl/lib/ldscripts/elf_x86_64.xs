...
ENTRY(_start)
SEARCH_DIR("=/opt/x-tools/x86_64-unknown-linux-musl/x86_64-unknown-linux-musl/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/opt/x-tools/x86_64-unknown-linux-musl/x86_64-unknown-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
