...
ENTRY(_start)
SEARCH_DIR("=/opt/x-tools/x86_64-unknown-linux-musl/x86_64-unknown-linux-musl/libx32"); SEARCH_DIR("=/usr/local/libx32"); SEARCH_DIR("=/libx32"); SEARCH_DIR("=/usr/libx32"); SEARCH_DIR("=/opt/x-tools/x86_64-unknown-linux-musl/x86_64-unknown-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
