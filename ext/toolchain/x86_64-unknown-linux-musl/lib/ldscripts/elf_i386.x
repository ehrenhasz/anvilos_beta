...
OUTPUT_ARCH(i386)
ENTRY(_start)
SEARCH_DIR("=/opt/x-tools/x86_64-unknown-linux-musl/i386-unknown-linux-musl/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/opt/x-tools/x86_64-unknown-linux-musl/i386-unknown-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
